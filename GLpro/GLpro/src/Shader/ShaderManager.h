...
{
	SHADER_TYPE_MAIN = 0, SHADER_TYPE_SHADOW = 1, SHADER_TYPE_COLISION = 2, SHADER_TYPE_SKYBOX = 3, SHADER_TYPE_PARTICLE = 4, SHADER_TYPE_TEXT = 5, SHADER_TYPE_TEXTURESIMPLE = 6, SHADER_TYPE_NUM
};
