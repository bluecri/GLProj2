...
struct ShaderStructDeferredPointLight
{
	...
	int			_lightNum;
	float		_lightPower[MAX_DFFERED_POINTL_LIGHT_NUM];
	glm::vec4	_lightColorVec4Vec[MAX_DFFERED_POINTL_LIGHT_NUM];
	glm::vec3	_lightPosVec3Vec[MAX_DFFERED_POINTL_LIGHT_NUM];
};